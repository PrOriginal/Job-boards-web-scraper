...
df["Expected technologies"] =  df["Expected technologies"].apply(', '.join).replace("", "Not specified")
df["Optional technologies"] =  df["Optional technologies"].apply(', '.join).replace("", "Not specified")
df = df.style.format(hyperlinks = "html").set_table_styles(css_styles)
html = df.to_html()
